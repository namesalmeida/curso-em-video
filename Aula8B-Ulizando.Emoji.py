# ver na lista os codigos dos emojis> https://carpedm20.github.io/emoji/
import emoji
...
print('Sou seu computador... Acabei de pesnar em um núemro entre 0 e 10.')
...
print('Acertou miseravi \U0001F923 com {} tentativas. Parabéns!'.format(palpites))
